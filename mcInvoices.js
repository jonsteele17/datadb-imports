...
const filename = "MC Invoice - Sales Value by Customer.xls"; // 'MC Invoice - Sales Value by Customer.xlsx' is in the same folder as this file
const expectedSheetName = "MC Invoice - Sales Value by Cus"; // The name of the sheet in the excel file
...
pool.getConnection((err, connection) => {
    ...
    for (const record of records) {
        let sql = "INSERT INTO mcInvoices SET ?";
        let values = record;
        try {
            // Use the connection
            //console.log(values);
